...
CREATE TABLE 生産タスク (
    ...
    合計数 INT NOT NULL COMMENT '目標生産数',
...
CREATE TABLE カウント履歴 (
    ...
    終了時刻 DATETIME DEFAULT NULL COMMENT '終了時刻（FinishTime）',
...
-- 生産タスク
INSERT INTO 生産タスク (
    管理者ID, ライン名, 商品名, ステータス, 合計数, 生産数, 
    予定終了時刻, 予定終了日, 終了見込時刻, 終了見込日
) VALUES (
    1, 'Aライン', 'TV結1', 'in_progress', 1630, 550, 
...
INSERT INTO 生産タスク (
    ...
    1, 'Aライン', 'TV結2', 'in_progress', 1970, 550, 
    '19:30', '2025-12-27', '20:00', '2025-12-31'
)
